    ...
    <section className="pt-8 pb-20">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          ...
          <a href="https://www.linkedin.com/in/kshitij-saxena-nst/" target="_blank" rel="noopener noreferrer" className="bg-[#D4FF80] rounded-[2rem] p-6 h-32 flex items-center gap-6 relative overflow-hidden group transition-transform hover:scale-[1.02]">
