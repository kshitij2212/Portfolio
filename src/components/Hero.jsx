    ...
    <section className="pt-8 pb-20">
      ...
      >
        ...
        <div className="flex flex-wrap gap-12 md:gap-24 mb-16">
          <div>
            <h3 className="text-5xl md:text-6xl font-bold text-white mb-2 tracking-tighter">+4</h3>
            <p className="text-xs text-textSecondary uppercase tracking-widest leading-relaxed">Major<br/>Projects</p>
          </div>
          <div>
          ...
          <div>
            <h3 className="text-5xl md:text-6xl font-bold text-white mb-2 tracking-tighter">+100</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          ...
          <a href="https://linkedin.com/in/kshitijsaxena" target="_blank" rel="noopener noreferrer" className="bg-[#D4FF80] rounded-[2rem] p-6 h-32 flex items-center gap-6 relative overflow-hidden group transition-transform hover:scale-[1.02]">
